...
# Compute Christoffel symbols for the 2-sphere / 3D Euclidean spherical-coordinate metric
...
- `sphere_example.py`: Computing quantities for a 2-sphere (3D Euclidean spherical-coordinate) metric
...
- `spherical_polar_metric(coordinates)`: 2-sphere (3D Euclidean spherical-coordinate) metric in (r, θ, φ)
